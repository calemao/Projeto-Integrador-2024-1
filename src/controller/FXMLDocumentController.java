...
public class FXMLDocumentController implements Initializable {
 ...
 private void btnExporta(ActionEvent event) {
    ...
    if (!isButtonPressed) {
        ...
        atualizarDados(comboBoxMunicipios.getSelectionModel().getSelectedItem());
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            if (selectedMunicipio != null) {
                ...
                // Atualizar os dados do município selecionado
                atualizarDados(selectedMunicipio);
